...
export default function Page() {
    ...
    return (
        <main className="mt-32 mb-10">
            ...
            <div className="programmes px-4 grid grid-cols-1 md:grid-cols-4 gap-x-8 gap-y-6">
                {programmes.map((item) => (
...
function ProgrammeCard({ item }) {
    ...
    const headingClass = isPaid
        ? "text-sm! text-bright font-semibold"
        : "text-sm! text-blue font-semibold";    
    ...
    return (
        <div data-aos="zoom-out">
            ...
            <Image
                src={item.image}
                className="relative z-20 border border-blue curve"
                alt="programme image"
            />
